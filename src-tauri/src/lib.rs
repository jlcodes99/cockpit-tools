...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex_switcher::codex_switcher_list_accounts,
            commands::codex_switcher::codex_switcher_import_access_token,
            commands::codex_switcher::codex_switcher_redeem_activation_code,
            commands::codex_switcher::codex_switcher_switch_account,
            commands::codex_switcher::codex_switcher_switch_best_account,
            commands::codex_switcher::codex_switcher_refresh_account_quota,
            commands::codex_switcher::codex_switcher_refresh_all_quotas,
            commands::codex_switcher::codex_switcher_delete_account,
            commands::codex_switcher::codex_switcher_get_settings,
            commands::codex_switcher::codex_switcher_update_settings,
            commands::codex_switcher::codex_switcher_fetch_remote_ad,
