...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::claude::create_claude_account,
            commands::claude::delete_claude_account,
            commands::claude::delete_claude_accounts,
            commands::claude::refresh_claude_account,
            commands::claude::refresh_all_claude_accounts,
            ...
            commands::claude::get_claude_login_command,
            commands::claude::get_claude_launch_command,
            commands::claude::execute_claude_login_command,
            commands::claude::execute_claude_launch_command,
            // Gemini Commands
