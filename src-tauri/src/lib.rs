...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // OpenRouter Commands
            commands::openrouter::list_openrouter_accounts,
            commands::openrouter::add_openrouter_account,
            commands::openrouter::delete_openrouter_account,
            commands::openrouter::delete_openrouter_accounts,
            commands::openrouter::import_openrouter_from_json,
            commands::openrouter::export_openrouter_accounts,
            commands::openrouter::refresh_openrouter_token,
            commands::openrouter::refresh_all_openrouter_tokens,
            commands::openrouter::inject_openrouter_account,
            commands::openrouter::update_openrouter_account_tags,
            commands::openrouter::fetch_openrouter_credits,
            commands::openrouter::fetch_openrouter_models,
            commands::openrouter::fetch_openrouter_activity,
            // Qoder Commands
