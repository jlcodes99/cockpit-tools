...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::grok::get_current_grok_account,
            ...
            commands::grok::refresh_grok_token,
            commands::grok::refresh_all_grok_tokens,
            commands::grok::update_grok_account_tags,
            commands::grok::get_grok_accounts_index_path,
            commands::grok::get_grok_auth_json_path,
            commands::grok::switch_grok_account,
            commands::grok::inject_grok_account,
