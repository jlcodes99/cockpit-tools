...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex_instance::codex_preview_session_visibility_source_repairs,
            ...
            commands::codex_instance::codex_preview_restore_sessions_from_trash_across_instances,
            commands::codex_instance::codex_restore_sessions_from_trash_across_instances,
            commands::codex_instance::codex_list_session_restore_rollout_backups,
            commands::codex_instance::codex_restore_session_restore_rollout_backup,
