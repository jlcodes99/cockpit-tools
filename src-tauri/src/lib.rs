...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::opencode_go::delete_opencode_go_connection,
            commands::opencode_go::query_opencode_go_quota,
            commands::opencode_go::query_all_opencode_go_quotas,
            commands::opencode_go::test_opencode_connection,
            commands::opencode_go::list_opencode_go_api_keys,
            commands::opencode_go::add_opencode_go_api_key,
            commands::opencode_go::update_opencode_go_api_key,
            commands::opencode_go::set_opencode_go_api_key_enabled,
            commands::opencode_go::delete_opencode_go_api_key,
            commands::opencode_go::refresh_opencode_go_api_key,
