...
const workbuddyPlatformConfig: CodebuddySuiteAccountsPlatformConfig<WorkbuddyAccount> = {
  ...
  syncButtonTitle: (t) => `${t('common.shared.import.label', "Import")} ${t('nav.codebuddyCn', 'CodeBuddy CN')}`,
  syncSuccessMessage: (t, count) => t('common.shared.token.importSuccessMsg', "Imported {{count}} account(s) successfully", { count }),
  syncFailedMessage: (t, error) => t('common.shared.token.importFailedMsg', "Import failed: {{error}}", { error }),
