...
const codebuddyCnPlatformConfig: CodebuddySuiteAccountsPlatformConfig<CodebuddyAccount> = {
  ...
  syncButtonTitle: (t) => t('codebuddyCn.syncToWorkbuddy', "Sync to WorkBuddy"),
  syncSuccessMessage: (t, count) => t('codebuddyCn.syncSuccess', "{{count}} account(s) synced to WorkBuddy", { count }),
  syncFailedMessage: (t, error) => t('codebuddyCn.syncFailed', "Sync failed: {{error}}", { error }),
